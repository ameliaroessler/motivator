class Motivator
  ...
  def suggest2
    if @mood == "happy" && @day == "busy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Aspotify_germany%3Aplaylist%3A6zQkNlFnpNO5BB0MG9c165" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif  @mood == "happy" && @day == "lazy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Aspotify_germany%3Aplaylist%3A6zQkNlFnpNO5BB0MG9c165" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "confident" && @day == "busy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Aspotify_norway_%3Aplaylist%3A2a3UtqixfCAGhUK049YoJI" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "confident" && @day == "lazy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Aspotify_norway_%3Aplaylist%3A2a3UtqixfCAGhUK049YoJI" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "scared" && @day == "busy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Afestvaning%3Aplaylist%3A6ejYLhKdDHCrydL7wIBTe6" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "scared" && @day == "lazy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Afestvaning%3Aplaylist%3A6ejYLhKdDHCrydL7wIBTe6" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "ecstatic" && @day == "busy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Aspotify_netherlands%3Aplaylist%3A5Vdl8E50GyWL6Ng2vMqhWe" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "ecstatic" && @day == "lazy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Aspotify_netherlands%3Aplaylist%3A5Vdl8E50GyWL6Ng2vMqhWe" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "sad" && @day == "busy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Akinehund%3Aplaylist%3A0v6MmRkqD3aelsmP5ZuL02" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "sad" && @day == "lazy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Akinehund%3Aplaylist%3A0v6MmRkqD3aelsmP5ZuL02" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "angry" && @day == "busy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Akerwino%3Aplaylist%3A4mCGD3C9QXhrWv3uBIpbRF" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    elsif @mood == "angry" && @day == "lazy"
      return '<iframe src="https://embed.spotify.com/?uri=spotify%3Auser%3Akerwino%3Aplaylist%3A4mCGD3C9QXhrWv3uBIpbRF" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>'
    end
  end
